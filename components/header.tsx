      ...
      <nav>
        <div className="flex items-center gap-1 ">
          ...
          <div className="inline-flex items-center gap-5 rounded-full  bg-white/10 backdrop-blur-lg border border-white/20 px-3 py-2 text-sm font-medium text-white shadow-lg">
            <div className="ml-2 relative w-8 h-8 text-sm font-medium overflow-hidden shrink-0 flex items-center justify-center">
              <Image
                src="/assets/logo.png"
                alt="logo"
                fill
            ...
            <a
              className="text-white text-[16px] border border-[#fe7b4b] rounded-full px-4 py-1 hover:bg-[#fe7b4b] hover:text-white transition"
